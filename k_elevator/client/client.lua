...
AddEventHandler('k_elevator:goToFloor', function(data)
...
AddEventHandler('k_elevator:noAccess', function()
    lib.notify({
        title = 'Nessun Accesso',
        description = 'Non hai accesso a questo piano!',
        type = 'error'
    })
end)

AddEventHandler('k_elevator:openMenu', function(data)
    ...
    for k,v in pairs(elevatorData) do
        if k == floor then
            table.insert(Options, {
                title = v.title..' (Corrente)',
                description = v.description,
                event = '',
                --args = { elevator = elevator, floor = k } --COMMENTO
            })
